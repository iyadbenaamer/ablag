...
app.post("/api/rephrase", async (req, res) => {
  try {
    ...
    const systemPrompt =
      "أنت مساعد لغوي عربي محترف. أعِد صياغة النص التالي بصياغة فصيحة واحترافية، صحّح الأخطاء النحوية والإملائية، وحافظ على المعنى الأصلي دون إضافة معلومات جديدة. قدّم النتيجة فقط دون شرح.";
